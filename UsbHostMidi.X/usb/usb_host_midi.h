...
#define EVENT_MIDI_DEBUG_LED_ON (EVENT_AUDIO_BASE+EVENT_MIDI_OFFSET+3)
...
/*******************************************************************************
  Function:
    bool USBHostMIDIDeviceDetect( uint8_t deviceAddress )

  Description:
    This function determines if a MIDI device is attached and ready to use.
...
*******************************************************************************/
MIDI_DEVICE* USBHostMIDIDeviceDetect( void );   
