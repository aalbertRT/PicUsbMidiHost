...
#define LED_D1_PORT     _LATB2 
#define LED_D2_PORT     _LATB3
#define LED_D3_PORT     _LATB7
#define LED_D4_PORT     _LATB5

#define LED_D1_TRIS     _TRISB2
#define LED_D2_TRIS     _TRISB3
#define LED_D3_TRIS     _TRISB7
#define LED_D4_TRIS     _TRISB5
...
bool LED_Get(LED led)
{
    ...
    {
        case LED_D1:
            return ( ( LED_D1_PORT == LED_ON ) ? true : false ) ;

        case LED_D2:
            return ( ( LED_D2_PORT == LED_ON ) ? true : false ) ;
            
        case LED_D3:
            return ( ( LED_D3_PORT == LED_ON ) ? true : false ) ;

        case LED_D4:
            return ( ( LED_D4_PORT == LED_ON ) ? true : false ) ;
